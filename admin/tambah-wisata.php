            ...
            <div class="latest-added mt-5">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <form action="proses_tambahwisata.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3 px-2">
                                ...
                                <div class="col-md-4 mt-md-4">
                                    <div class="mb-3 px-2">
                                        ...
                                        <input class="form-control" type="text" placeholder="ket..." id="st_admsn" name="ket">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-md-4">
                                    <div class="mb-3 px-2">
